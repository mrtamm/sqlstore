 ...
 * <code>ws.rocket.sqlstore.db</code> package, which tests the main API, integrity of
 ...
 * </ul>
 *
 * <p>These resources are copied to package <code>ws.rocket.sqlstore.db</code> by build script
