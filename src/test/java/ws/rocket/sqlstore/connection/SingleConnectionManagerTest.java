...
public final class SingleConnectionManagerTest {
  ...
  public void shouldFailWhenNoConnectionOnConstruct() {
    new SingleConnectionManager(null);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void shouldFailWhenClosedConnectionOnConstruct() throws SQLException {
    Connection con = mock(Connection.class);
    when(con.isClosed()).thenReturn(true);

    new SingleConnectionManager(con);
  }
