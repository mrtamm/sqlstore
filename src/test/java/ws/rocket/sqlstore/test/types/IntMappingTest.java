...
import ws.rocket.sqlstore.types.IntMapper;
...
public class IntMappingTest {
  ...
  private final IntMapper mapper = new IntMapper();

  public void shouldAcceptInteger() {
    assertTrue(this.mapper.supports(int.class));
    assertTrue(this.mapper.supports(Integer.class));
  }
  ...
  public void shouldWriteIntToStatement() throws SQLException {
    ...
    this.mapper.write(stmt, 1, 2, Types.NUMERIC);

    verify(stmt).setInt(1, 2);
  }
  ...
  public void shouldReadIntFromStatement() throws SQLException {
    ...
    assertEquals(this.mapper.read(stmt, 1, Types.NUMERIC), Integer.valueOf(2));
  }
  ...
  public void shouldReadIntFromResultSet() throws SQLException {
    ...
    assertEquals(this.mapper.read(rs, 1, Types.BOOLEAN), Integer.valueOf(2));
  }
